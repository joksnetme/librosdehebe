...
<div>
  <div id="breadcrumb">
    ...
    <a href="/admincp/envios/agregar/">Agregar</a>
  </div>
  <h1>Agregar Formas de Env&iacute;o</h1>
  <h2>Ingrese los datos de env&iacute;o, puede ser por v&iacute;a &aacute;erea, mar&iacute;tima o terrestre.</h2>
  <form action="/admincp/envios/agregar/" method="post">
<!-- BEGIN validation -->
    <ul class="validation">
...
<!-- END validation -->
    <dl>
      ...
      <dt class="pais hidden"><label for="pais">Pa&iacute;s</label></dt>
      <dd class="pais hidden">
        <select name="pais" id="pais" >
          <option value="" class="">Seleccionar</option>
<!-- BEGIN paises -->
          <option value="{paises.id_paises}">{paises.pais}</option>
<!-- END paises -->
        </select>
      </dd>
