<div>
  <div id="breadcrumb">
    ...
    <a href="/admincp/pagos/agregar/">Agregar</a>
  </div>
  <h1>Agregar Pago</h1>
  <h2>Agregar Pago</h2>
  <form action="/admincp/pagos/agregar/" method="post">
<!-- BEGIN validation -->
    <ul class="validation">
...
<!-- BEGIN meta -->
      ...
      <dd><input type="text" name="metaValue[{meta.i}]" value="{meta.value}" size="30" /></dd>
<!-- END meta -->
