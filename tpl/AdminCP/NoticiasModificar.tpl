...
<div>
  <div id="breadcrumb">
    ...
    <a href="/admincp/noticias/{id_noticias}/">{titulo}</a> &raquo;
    <a href="/admincp/noticias/{id_noticias}/modificar/">Modificar</a>
  </div>
  <h1>Modificar Noticia</h1>
  <h2>Modificando la noticia {titulo}.</h2>
...
<!-- END specialchars -->
  <div class="sintaxis">
    ...
    <p>
      ...
      <dd class="only"><hr /></dd>
      <dd>
        <input type="hidden" name="id_noticias" id="id_noticias" value="{id_noticias}" />
